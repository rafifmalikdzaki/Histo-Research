...
if __name__ == '__main__':
    ...
    wandb_logger = WandbLogger(
        ...
        config={
            ...
            'device': str(device),
            'num_workers': num_workers,
            'model': 'DAE_KAN_Attention_with_Auto_Analysis',
            'analysis_frequency': args.analysis_freq,
            'auto_analysis_features': [
                'automatic_attention_extraction',
                'real_time_metrics_tracking',
                'batch_visualization',
                'performance_monitoring',
                'comprehensive_reporting'
            ]
        },
        tags=['DAE-KAN', 'histopathology', 'autoencoder', 'automatic-analysis']
    )
